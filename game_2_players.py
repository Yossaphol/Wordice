...
def game_2_players():
    ...
    while running:
        ...
        elif 19 <= pos_1 < 25 or 11 <= pos_1 < 14 or 6 <= pos_1 < 9:
        ...
        elif 19 <= pos_2 < 25 or 11 <= pos_2 < 14 or 6 <= pos_2 < 9:
            screen.blit(backside2_flip, p2_pos[pos_2])


        if not alert:
            describe = pygame.font.Font("fonts/Pixelify.ttf", 50)
            describe = describe.render("Press space bar for next step", True, "RED", "WHITE")
